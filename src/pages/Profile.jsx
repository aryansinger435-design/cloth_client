    ...
    return (
        <div className="min-h-screen bg-[#040406] text-slate-100 py-10 selection:bg-[#D4AF37] selection:text-black">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                {/* Profile Banner */}
                <div className="bg-[#07080D] rounded-3xl border border-[#151722] p-5 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 shadow-xl">
                    <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
                        <div className="w-18 h-18 sm:w-20 sm:h-20 rounded-2xl bg-[#0A0C13] border border-[#D4AF37]/50 flex items-center justify-center text-[#D4AF37] text-2xl font-black font-serif shadow-[0_0_20px_rgba(212,175,55,0.25)] shrink-0">
                            {user?.first_name?.[0]?.toUpperCase() || "C"}
                        </div>
                        <div>
                            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                                <h1 className="text-xl sm:text-2xl font-bold text-white font-serif">{user?.first_name} {user?.last_name}</h1>
                    ...
                    <div className="flex items-center justify-center sm:justify-end w-full sm:w-auto">
                        <button
                            ...
                            className="w-full sm:w-auto text-center px-4 py-2 rounded-xl bg-[#0A0C13] hover:bg-[#20273D] text-xs font-bold text-[#E5C158] border border-[#D4AF37]/40 transition shadow-sm"
                        >
                ...
                <div className="bg-[#07080D] rounded-3xl border border-[#151722] p-5 sm:p-8 space-y-6 shadow-xl">
                    ...
                    <form onSubmit={handleProfileSubmit} className="space-y-4 text-xs">
                        ...
                        <div className="pt-2">
                            <button
                                type="submit"
                                className="w-full sm:w-auto px-6 py-2.5 bg-gradient-to-r from-[#C5A059] to-[#D4AF37] hover:from-[#D4AF37] hover:to-[#E5C158] text-black font-extrabold text-xs uppercase tracking-wider rounded-xl transition flex items-center justify-center gap-1.5 shadow-[0_0_15px_rgba(212,175,55,0.3)]"
                            >
